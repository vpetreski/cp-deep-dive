...
/**
 * Mirror of [data/nsp/schema.json] — the JSON format shared across every
 * solver in the repo. Kept in this module as a private copy to avoid
 * cross-module build coupling; see CLAUDE.md for the rationale.
 *
 * Only the fields Ch18's comparability set needs are modelled here. Unknown
 * keys are ignored at parse time, so future schema additions don't break
 * this reader.
 */
@Serializable
